...
class WeeklyPatientNutritionReportHome extends StatefulWidget {
  final UserModel curentUser;
  final UserModel patient;
  const WeeklyPatientNutritionReportHome(
      {super.key, required this.curentUser, required this.patient});

  @override
  State<WeeklyPatientNutritionReportHome> createState() => _WeeklyPatientReportState();
}

class _WeeklyPatientReportState extends State<WeeklyPatientNutritionReportHome> {
  bool showbtn = false;
  bool loading = false;
  List<WeeklyPatientNutrientReportModel> reportList = [];
  @override
  void initState() {
  ...
  getInitData() async {
    ...
    reportList = await WeeklyNutrientReportService.fetchWeeklyNutrientReportByPatientId(
        widget.patient.id);
    setState(() {
      loading = false;
    });
                    ...
                    Row(
                      children: [
                        ...
                        Align(
                          ...
                          child: Text(
                            "${widget.patient.firstName}'s Weekly Nutrition Reports",
                        ...
                        MaterialButton(
                          onPressed: () async {
                            await Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => NutrientReportSummary(
                            ...
                            ? MaterialButton(
                                onPressed: () async {
                                  await Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => AddWeeklyNutrientReport(
