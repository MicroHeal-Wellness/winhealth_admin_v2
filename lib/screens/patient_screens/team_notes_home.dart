...
class TeamNotesHome extends StatefulWidget {
  ...
  @override
  State<TeamNotesHome> createState() => _NotesHomeState();
}

class _NotesHomeState extends State<TeamNotesHome> {
  bool showbtn = false;
  bool loading = false;
  List<Note> notes = [];
  ...
  getInitData() async {
    ...
    notes = await TeamNoteService.fetchNotesByPatientId(widget.patient.id!);
    setState(() {
      loading = false;
    });
  }
                    ...
                    Row(
                      children: [
                        ...
                        Align(
                          ...
                          child: Text(
                            "${widget.patient.firstName}'s Team Notes",
                                  ...
                                  itemBuilder: (context, index) {
                                    return NotesCard(
                                        ...
                                        onRemove: () async {
                                          ...
                                          bool resp =
                                              await TeamNoteService.removeNote(
                                                  notes[index].id);
                                          if (!resp) {
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                decoration: const InputDecoration(
                                  hintText: 'Enter Team note content',
                              ...
                              MaterialButton(
                                onPressed: () async {
                                  if (noteController.text.isEmpty) {
                                    ...
                                    bool resp =
                                        await TeamNoteService.addNote(payload);
                                    if (resp) {
