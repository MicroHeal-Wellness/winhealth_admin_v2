...
class EditTeamNotesHome extends StatefulWidget {
  final Note note;
  const EditTeamNotesHome({super.key, required this.note});

  @override
  State<EditTeamNotesHome> createState() => _EditTeamNotesHomeState();
}

class _EditTeamNotesHomeState extends State<EditTeamNotesHome> {
                  ...
                  MaterialButton(
                    onPressed: () async {
                      if (noteController.text.isEmpty) {
                        ...
                        bool resp = await TeamNoteService.updateNote(
                            widget.note.id, payload);
                        if (resp) {
                          Fluttertoast.showToast(msg: "Team Note Updated");
