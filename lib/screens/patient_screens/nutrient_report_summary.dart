...
class NutrientReportSummary extends StatefulWidget {
  final List<WeeklyPatientNutrientReportModel> reportList;
  const NutrientReportSummary({super.key, required this.reportList});

  @override
  State<NutrientReportSummary> createState() => _NutrientReportSummaryState();
}

class _NutrientReportSummaryState extends State<NutrientReportSummary> {
  bool showbtn = false;
  ...
  WeeklyPatientNutrientReportModel? dummyWeeklyPatientNutrientReportModel =
            ...
            const Row(
              children: [
                ...
                Align(
                  ...
                  child: Text(
                    "Summary of weekly nutrient report",
                    style: TextStyle(
                      fontSize: 24,
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                    ...
                    children: dummyWeeklyPatientNutrientReportModel!
                        .toJsonList()
                        .entries
                        .map(
                          (ent) => getSingleGraph(
